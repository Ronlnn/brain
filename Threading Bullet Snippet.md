...
:LiTags: Tags: #config  #snippet 
:LiCodepen: Dependencies: [[snippet]]
## Threading Bullet Snippet
- Сниппет для [[Threading Bullet Plugin]]

```css
/* Основные настройки для OutLine в режиме чтения */
...
.HyperMD-list-line-1:not(

    :has(~ .HyperMD-list-line-1 ~ .HyperMD-list-line.cm-active)
...
.HyperMD-list-line-2:not(

    :has(~ .HyperMD-list-line-2 ~ .HyperMD-list-line.cm-active)
...
    --list-threading-active-color: hsl(

      var(--list-threading-active-color-1, 23, 100%, 45%),

      var(--list-threading-active-alpha, 0.2)

    );

    --list-threading-active-offset: calc(

      var(--list-threading-active-offset-extra, 2px) +

        var(--list-padding-inline-start-fix)
...
.HyperMD-list-line-3:not(

    :has(~ .HyperMD-list-line-3 ~ .HyperMD-list-line.cm-active)
...
      var(--list-threading-active-color-2, 46, 100%, 45%),
...
        var(--list-padding-inline-start-fix) + var(--list-indent)
...
      ~ :is(.HyperMD-list-line-5, .HyperMD-list-line-6).cm-active

  ),

.HyperMD-list-line-4:not(

    :has(~ .HyperMD-list-line-4 ~ .HyperMD-list-line.cm-active)

  ):is(

    .cm-active,

    :has(~ :is(.HyperMD-list-line-5, .HyperMD-list-line-6).cm-active)
...
      var(--list-threading-active-color-3, 70, 100%, 45%),
...
        var(--list-padding-inline-start-fix) + 2 * var(--list-indent)
...
  ):has(~ :is(.HyperMD-list-line-6, .HyperMD-list-line-5).cm-active),
...
    ~ .HyperMD-list-line-5 ~ :is(.HyperMD-list-line-6).cm-active

  ),

.HyperMD-list-line-5:not(

    :has(~ .HyperMD-list-line-5 ~ .HyperMD-list-line.cm-active)

  ):is(.cm-active, :has(~ :is(.HyperMD-list-line-6).cm-active))
...
      var(--list-threading-active-color-4, 105, 100%, 45%),
...
        var(--list-padding-inline-start-fix) + 3 * var(--list-indent)
...
  ):has(~ :is(.HyperMD-list-line-6).cm-active),
...
  ~ .HyperMD-list-line:has(~ .HyperMD-list-line-6.cm-active),

.HyperMD-list-line-6:not(
...
      var(--list-threading-active-color-5, 187, 100%, 45%),
...
        var(--list-padding-inline-start-fix) + 4 * var(--list-indent)
...
  body.list-threading-active-elbow-bottom

    .is-live-preview

    &:is(.HyperMD-task-line)::before {
...
      ~ :is(.HyperMD-list-line-6, .HyperMD-list-line-5).cm-active
...
    border-bottom: var(--list-threading-active-width, 3px) solid

      var(--list-threading-active-color);

    border-left: var(--list-threading-active-width, 3px) solid
...
    :has(~ .HyperMD-list-line-1 ~ .HyperMD-list-line:hover)
...
    :has(~ .HyperMD-list-line-2 ~ .HyperMD-list-line:hover)
...
    --list-threading-hover-color: hsl(

      var(--list-threading-hover-color-1, 23, 100%, 45%),

      var(--list-threading-hover-alpha, 0.4)

    );

    --list-threading-hover-offset: calc(

      var(--list-threading-hover-offset-extra, 4px) +
...
    :has(~ .HyperMD-list-line-3 ~ .HyperMD-list-line:hover)
...
      var(--list-threading-hover-color-2, 46, 100%, 45%),
...
      ~ :is(.HyperMD-list-line-5, .HyperMD-list-line-6):hover

  ),

.HyperMD-list-line-4:not(

    :has(~ .HyperMD-list-line-4 ~ .HyperMD-list-line:hover)

  ):is(:hover, :has(~ :is(.HyperMD-list-line-5, .HyperMD-list-line-6):hover))
...
      var(--list-threading-hover-color-3, 70, 100%, 45%),
...
  ):has(~ :is(.HyperMD-list-line-6, .HyperMD-list-line-5):hover),
...
    ~ .HyperMD-list-line-5 ~ :is(.HyperMD-list-line-6):hover

  ),

.HyperMD-list-line-5:not(

    :has(~ .HyperMD-list-line-5 ~ .HyperMD-list-line:hover)

  ):is(:hover, :has(~ :is(.HyperMD-list-line-6):hover))
...
      var(--list-threading-hover-color-4, 105, 100%, 45%),
...
  ):has(~ :is(.HyperMD-list-line-6):hover),
...
  ~ .HyperMD-list-line:has(~ .HyperMD-list-line-6:hover),

.HyperMD-list-line-6:not(

    :has(~ .HyperMD-list-line-6 ~ .HyperMD-list-line:hover)
...
      var(--list-threading-hover-color-5, 187, 100%, 45%),
...
  body.list-threading-hover-elbow-bottom

    .is-live-preview

    &:is(.HyperMD-task-line)::after {
...
      ~ :is(.HyperMD-list-line-6, .HyperMD-list-line-5):hover
...
  ):is(:hover, :has(~ :is(.HyperMD-list-line-6, .HyperMD-list-line-5):hover)),
...
    border-bottom: var(--list-threading-hover-width, 1px) solid

      var(--list-threading-hover-color);

    border-left: var(--list-threading-hover-width, 1px) solid
